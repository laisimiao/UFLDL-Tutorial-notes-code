...
addpath E:\SummerCourse\UFLDL\stanford_dl_ex-master\common\minFunc_2012\minFunc
addpath E:\SummerCourse\UFLDL\stanford_dl_ex-master\common\minFunc_2012\minFunc\compiled
...
% train.X:784*60000  train.y:1*60000 
%  test.X:784*10000   test.y:1*10000
...
theta = rand(n,num_classes-1)*0.001; % size:785 * 9
...
fprintf('Optimization took %f seconds.\n', toc);%ÏÖÔÚthetaµÄsize£º785*9
theta=[theta, zeros(n,1)]; % expand theta to include the last class.size:785 * 10
