...
images = reshape(images,imageDim,imageDim,numImages); % images-->28*28*60000

W = randn(filterDim,filterDim,numFilters); % W-->8*8*100  正态分布的随机数
b = rand(numFilters,1);    % b-->100*1 均匀分布的随机数
...
convolvedFeatures = cnnConvolve(filterDim, numFilters, convImages, W, b); % 21*21*100*8
