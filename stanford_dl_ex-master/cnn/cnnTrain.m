...
images = loadMNISTImages('E:\SummerCourse\UFLDL\common\train-images-idx3-ubyte');
images = reshape(images,imageDim,imageDim,[]); % 28*28*60000
labels = loadMNISTLabels('E:\SummerCourse\UFLDL\common\train-labels-idx1-ubyte'); % 60000*1
labels(labels==0) = 10; % Remap 0 to 10

% Initialize Parameters
theta = cnnInitParams(imageDim,filterDim,numFilters,poolDim,numClasses); % 21650*1
...
testImages = loadMNISTImages('E:\SummerCourse\UFLDL\common\t10k-images-idx3-ubyte');
testImages = reshape(testImages,imageDim,imageDim,[]);
testLabels = loadMNISTLabels('E:\SummerCourse\UFLDL\common\t10k-labels-idx1-ubyte'); % 10000*1
