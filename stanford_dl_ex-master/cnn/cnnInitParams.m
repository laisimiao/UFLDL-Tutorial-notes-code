...
assert(filterDim < imageDim,'filterDim must be less that imageDim'); % 条件为 false 时引发错误

% c--convolutional layer   d--densely connected
...
outDim = outDim/poolDim; % 10
hiddenSize = outDim^2*numFilters; % 2000
