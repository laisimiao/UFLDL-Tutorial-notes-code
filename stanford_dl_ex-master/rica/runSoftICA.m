...
% Load MNIST data set 784*60000
data = loadMNISTImages('E:\SummerCourse\UFLDL\common\train-images-idx3-ubyte');
...
patches = samplePatches(data,params.patchWidth,params.m); % 81*10000
% Step 2) Apply ZCA
...
x = bsxfunwrap(@rdivide,patches,m); % 81*10000
